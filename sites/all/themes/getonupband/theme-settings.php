 ...
 */
function getonupband_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['getonupband_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('getonupband sample setting'),
  '#default_value' => theme_get_setting('getonupband_example'),
