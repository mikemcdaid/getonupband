...
@media print {
  ...
  *:after {
  ...
  .btn > .caret,
  .button > .caret,
  .dropup > .btn > .caret, .dropup > .button > .caret {
...
.btn-xs,
.btn-group-xs > .btn, .btn-group-xs > .button {
  padding: 1px 5px;
  font-size: 12px;
  line-height: 1.5;
  border-radius: 3px; }
...
select.input-group-lg > .input-group-btn > .btn, select.input-group-lg > .input-group-btn > .button {
  height: 46px;
  line-height: 46px; }
...
select[multiple].input-group-lg > .input-group-btn > .btn, select[multiple].input-group-lg > .input-group-btn > .button {
  height: auto; }
...
select.input-group-sm > .input-group-btn > .btn, select.input-group-sm > .input-group-btn > .button {
  height: 30px;
  line-height: 30px; }
...
select[multiple].input-group-sm > .input-group-btn > .btn, select[multiple].input-group-sm > .input-group-btn > .button {
  height: auto; }
...
.btn-xs .badge,
.btn-group-xs > .btn .badge, .btn-group-xs > .button .badge {
  top: 0;
  padding: 1px 5px; }
