...
@include add-breakpoint('single pixel value', $single-pixel-value);
@include add-breakpoint('single pixel value, em', $single-em-value);
...
@include add-breakpoint('basic or', $basic-or);

$monochrome: monochrome;
$monochrome-double: 300px monochrome;
$multidimensional-plus-one-sided: ($feature-first) ($feature-value-both-strings) ($monochrome);
...
@include add-breakpoint('device pixel ratio', $device-pixel-ratio);
