...
.test-layout {
  ...
  before: $zen-columns;
  @include zen-respond-to('m', true, $layout: test) {
    during: $zen-columns;
  }
  after: $zen-columns;
}
...
.test-columns {
  $zen-columns: 12 !global;
  before: $zen-columns;
  @include zen-respond-to('m', true, $columns: 6) {
    during: $zen-columns;
  }
  after: $zen-columns;
}
...
.test-gutters {
  ...
  before: $zen-gutters;
  @include zen-respond-to('m', true, $gutters: 10em) {
    during: $zen-gutters;
  }
  after: $zen-gutters;
}
...
.test-gutter-method {
  ...
  @include zen-respond-to('m', true, $gutter-method: margin) {
...
.test-grid-width {
  ...
  @include zen-respond-to('m', true, $grid-width: 90%) {
...
.test-box-sizing {
  ...
  @include zen-respond-to('m', true, $box-sizing: content-box) {
...
.test-direction {
  ...
  @include zen-respond-to('m', true, $direction: right) {
...
.test-switch-direction {
  ...
  @include zen-respond-to('m', true, $switch-direction: true) {
...
.test-rtl-selector {
  ...
  @include zen-respond-to('m', true, $rtl-selector: '[dir="rtl"]') {
...
.test-auto-include-grid-item-base {
  ...
  @include zen-respond-to('m', true, $auto-include-grid-item-base: false) {
...
.test-auto-include-flow-item-base {
  ...
  @include zen-respond-to('m', true, $auto-include-flow-item-base: false) {
...
.test-grid-color {
  ...
  @include zen-respond-to('m', true, $grid-color: #dedeff) {
...
.test-grid-numbers {
  ...
  @include zen-respond-to('m', true, $grid-numbers: top) {
