...
.test-layout {
  ...
  before: $zen-columns;
  @include zen-mq($breakpoint, true, $layout: test) {
    during: $zen-columns;
  }
  after: $zen-columns;
}
...
.test-columns {
  $zen-columns: 12 !global;
  before: $zen-columns;
  @include zen-mq($breakpoint, true, $columns: 6) {
    during: $zen-columns;
  }
  after: $zen-columns;
}
...
.test-gutters {
  ...
  before: $zen-gutters;
  @include zen-mq($breakpoint, true, $gutters: 10em) {
    during: $zen-gutters;
  }
  after: $zen-gutters;
}
...
.test-gutter-method {
  ...
  @include zen-mq($breakpoint, true, $gutter-method: margin) {
...
.test-grid-width {
  ...
  @include zen-mq($breakpoint, true, $grid-width: 90%) {
...
.test-box-sizing {
  ...
  @include zen-mq($breakpoint, true, $box-sizing: content-box) {
...
.test-direction {
  ...
  @include zen-mq($breakpoint, true, $direction: right) {
...
.test-switch-direction {
  ...
  @include zen-mq($breakpoint, true, $switch-direction: true) {
...
.test-rtl-selector {
  ...
  @include zen-mq($breakpoint, true, $rtl-selector: '[dir="rtl"]') {
...
.test-auto-include-grid-item-base {
  ...
  @include zen-mq($breakpoint, true, $auto-include-grid-item-base: false) {
...
.test-auto-include-flow-item-base {
  ...
  @include zen-mq($breakpoint, true, $auto-include-flow-item-base: false) {
...
.test-grid-color {
  ...
  @include zen-mq($breakpoint, true, $grid-color: #dedeff) {
...
.test-grid-numbers {
  ...
  @include zen-mq($breakpoint, true, $grid-numbers: top) {
